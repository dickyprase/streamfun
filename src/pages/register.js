...
export default function RegisterPage() {
  ...
  const { register, isAuthenticated, siteSettings } = useAuth();
  ...
  return (
    <>
      <Head>
        <title>Daftar - {siteSettings.site_name}</title>
      </Head>
        ...
        >
          <div className="bg-dark-200 border border-dark-400 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm mt-1">Daftar untuk mulai streaming</p>
            </div>
